  ...
  return (
    <div className="hidden md:flex flex-col w-64 bg-nm-white border-r border-nm-grey-200 h-screen sticky top-0">
      <div className="p-6">
        ...
        {isSeller && (
          <span className="text-[10px] bg-nm-gold px-2 py-0.5 rounded-full mt-2 inline-block font-bold text-nm-black uppercase">
            Vendor Portal
          </span>
        )}
      </div>
      ...
      <div className="p-4 border-t border-nm-grey-200 m-4">
        <Link
          ...
          className="flex items-center gap-2 text-sm text-nm-grey-500 hover:text-nm-black transition-colors font-bold"
        >
